...
// receive POST data from Jotform

$formData['origin'] = $_POST['origin'];
$formData['id'] = isset($dream->id)?$dream->id:'';
$formData['date'] = $_POST['date']['2']."-".$_POST['date']['1']."-".$_POST['date']['0'];
$formData['description'] = $_POST['description'];
$formData['title'] = $_POST['title'];
$formData['color'] = $_POST['color'];
$formData['image_file'] = $_POST['animage']['0'];
$formData['email'] = $_POST['email'];
$formData['submit'] = True;

echo "id is".$dream->id; echo nl2br("\n"); //delete later
echo '<pre>'; print_r($formData); echo '</pre>';

//$formData = EMBEDDED ? $_GET : $_POST; Code from contribute.php
...
{
	echo "processing form"; echo nl2br("\n"); //delete later
...
// posting form data to api/dream/index.php
	...
	if ($response === false)
	{
		...
		$status = "Oops, something went wrong with the curl post.";
	}
	else
	{
	...
	echo "Response: "; echo '<pre>'; print_r($response); echo '</pre>'; echo nl2br("\n"); //delete later
	...
	if( !$success )
	{
		...
		if( !isset($status) )
			$status = "Oops! Something went wrong with the data validation.";
	}
	else
	{
...
echo "Status: ".$status; echo nl2br("\n"); //delete later

echo "Response: "; echo '<pre>'; print_r($response); echo '</pre>'; echo nl2br("\n"); //delete later

echo "Success: ".$success; echo '</pre>'; echo nl2br("\n"); //delete later
